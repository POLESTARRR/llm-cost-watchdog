...
# is real tokens doing real work, but it is covered by a flat monthly fee, so
# no per-token charge ever occurred. Counting it as billed spend would overstate
